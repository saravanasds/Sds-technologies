...
function Testimonials() {
    return (
        <div className="bg-gradient-to-r from-black via-[#4d6b9c82] to-black rounded-lg flex flex-col items-center justify-center max-h-auto sm:p-10 pt-20 overflow-hidden lg:px-10 px-5" data-aos="flip-up" data-aos-delay="800">
